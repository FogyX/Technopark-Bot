# Бот для записи на мероприятия «Точки кипения» (LeaderID)

## Telegram-бот, разработанный для удобной записи участников на мероприятия центра «Точка кипения». Интегрирован с официальным API LeaderID.
...
- Для пользователей: авторизация по LeaderID, просмотр мероприятий, запись на мероприятия, получение уведомлений, подписка на рассылку, отправка заявки на партнёрство.
- Для администраторов (через отдельного бота): создание рассылки, получение заявок на партнёрство.

### Парочка скринов
<img width="300" height="500" alt="image" src="https://github.com/user-attachments/assets/885435de-503a-4a47-8ccb-38547f07db01" />
<img width="300" height="250" alt="image" src="https://github.com/user-attachments/assets/c32d7150-b9e2-434c-9b78-7ca1abf00265" />
<img width="300" height="500" alt="image" src="https://github.com/user-attachments/assets/47567779-5265-43db-8632-0a58022b3952" />
